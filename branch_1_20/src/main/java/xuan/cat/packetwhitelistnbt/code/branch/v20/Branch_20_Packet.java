...
import xuan.cat.packetwhitelistnbt.code.branch.v20.packet.*;
...
public final class Branch_20_Packet implements BranchPacket {
    ...
    public void convertSetSlot(PacketSetSlotEvent event, Function<org.bukkit.inventory.ItemStack, org.bukkit.inventory.ItemStack> convert) {
        Branch_20_PacketSetSlot packet = new Branch_20_PacketSetSlot((ClientboundContainerSetSlotPacket) event.getPacket());
    ...
    public void convertWindowItems(PacketWindowItemsEvent event, Function<org.bukkit.inventory.ItemStack, org.bukkit.inventory.ItemStack> convert) {
        Branch_20_PacketWindowItems packet = new Branch_20_PacketWindowItems((ClientboundContainerSetContentPacket) event.getPacket());
    ...
    public void convertWindowMerchants(PacketOpenWindowMerchantEvent event, Function<MerchantRecipe, MerchantRecipe> convert) {
        Branch_20_PacketOpenWindowMerchant packet = new Branch_20_PacketOpenWindowMerchant((ClientboundMerchantOffersPacket) event.getPacket());
    ...
    public void convertEntityEquipment(PacketEntityEquipmentEvent event, Function<org.bukkit.inventory.ItemStack, org.bukkit.inventory.ItemStack> convert) {
        Branch_20_PacketEntityEquipment packet = new Branch_20_PacketEntityEquipment((ClientboundSetEquipmentPacket) event.getPacket());
    ...
    public void convertRecipeUpdate(PacketRecipeUpdateEvent event, Function<Recipe, Recipe> convert) {
        Branch_20_PacketRecipeUpdate packet = new Branch_20_PacketRecipeUpdate((ClientboundUpdateRecipesPacket) event.getPacket());
