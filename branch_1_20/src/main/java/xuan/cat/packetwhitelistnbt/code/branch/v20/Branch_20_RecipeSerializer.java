...
public final class Branch_20_RecipeSerializer {
    ...
    public static net.minecraft.world.item.crafting.Recipe fromBukkit(Recipe recipe) {
        if (recipe instanceof org.bukkit.inventory.BlastingRecipe) {
            ...
            return new net.minecraft.world.item.crafting.BlastingRecipe(craftRecipe.getGroup(), CraftRecipe.getCategory(craftRecipe.getCategory()), craftRecipe.toNMS(craftRecipe.getInputChoice(), true), CraftItemStack.asNMSCopy(craftRecipe.getResult()), craftRecipe.getExperience(), craftRecipe.getCookingTime());
            ...
            return new CampfireCookingRecipe(craftRecipe.getGroup(), CraftRecipe.getCategory(craftRecipe.getCategory()), craftRecipe.toNMS(craftRecipe.getInputChoice(), true), CraftItemStack.asNMSCopy(craftRecipe.getResult()), craftRecipe.getExperience(), craftRecipe.getCookingTime());
            ...
            return new SmeltingRecipe(craftRecipe.getGroup(), CraftRecipe.getCategory(craftRecipe.getCategory()), craftRecipe.toNMS(craftRecipe.getInputChoice(), true), CraftItemStack.asNMSCopy(craftRecipe.getResult()), craftRecipe.getExperience(), craftRecipe.getCookingTime());
            ...
            ShapedRecipePattern pattern = new ShapedRecipePattern(width, shapeList.length, data, null); //TODO - HELP ME PLEASE
            return new ShapedRecipe(craftRecipe.getGroup(), CraftRecipe.getCategory(craftRecipe.getCategory()), pattern, CraftItemStack.asNMSCopy(craftRecipe.getResult()));
            ...
            return new ShapelessRecipe(craftRecipe.getGroup(), CraftRecipe.getCategory(craftRecipe.getCategory()), CraftItemStack.asNMSCopy(craftRecipe.getResult()), data);
            ...
            return new SmithingTrimRecipe(craftRecipe.toNMS(craftRecipe.getTemplate(), true), craftRecipe.toNMS(craftRecipe.getBase(), true), craftRecipe.toNMS(craftRecipe.getAddition(), true));
            ...
            return new SmithingTransformRecipe(craftRecipe.toNMS(craftRecipe.getTemplate(), true), craftRecipe.toNMS(craftRecipe.getBase(), true), craftRecipe.toNMS(craftRecipe.getAddition(), true), CraftItemStack.asNMSCopy(craftRecipe.getResult()));

        } /*else if (recipe instanceof org.bukkit.inventory.SmithingRecipe) {
            SmithingRecipe craftRecipe = SmithingRecipe.fromBukkitRecipe((org.bukkit.inventory.SmithingRecipe) recipe);
            try {
                // 適用於 paper
            ...
            return new SmokingRecipe(craftRecipe.getGroup(), CraftRecipe.getCategory(craftRecipe.getCategory()), craftRecipe.toNMS(craftRecipe.getInputChoice(), true), CraftItemStack.asNMSCopy(craftRecipe.getResult()), craftRecipe.getExperience(), craftRecipe.getCookingTime());
            ...
            return new StonecutterRecipe(craftRecipe.getGroup(), craftRecipe.toNMS(craftRecipe.getInputChoice(), true), CraftItemStack.asNMSCopy(craftRecipe.getResult()));
